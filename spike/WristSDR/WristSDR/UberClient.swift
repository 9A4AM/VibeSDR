...
final class UberClient: ObservableObject {
  ...
  private func openSpectrum() {
    ...
    // ★ 1024 on EVERY path, the relay included: Stuart, 2026-09-17 — "keep the servers all as
    //   close as possible to each other in terms of how they display". A 512-on-relay cut was
    //   tried for an hour and reverted; the calibrated link detector never showed the relay short
    //   of budget, and the "reconnecting" it was meant to cure was an indicator tuned for 15 fps.
