/* ★★★ VibeServer's OWN copy of the connection meter / rate controller (2026-09-22) — see
 *  VibeServerWsClient.ts. Began identical to linkManager.ts, which is now UberSDR's. A change for
 *  one server type is made in its own file; a change for both is made twice, on purpose. */
